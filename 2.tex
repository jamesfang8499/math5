...
\begin{figure}[htp]
    \centering
\includegraphics[scale=.6]{fig/2-30.png}
    \caption{}
\end{figure}
...
\begin{figure}[htp]
    \centering
\includegraphics[scale=.6]{fig/2-31.png}
    \caption{}
\end{figure}
...
\begin{figure}[htp]
    \centering
 \includegraphics[scale=.6]{fig/2-40.png}   
    \caption{}
\end{figure}
...
\begin{figure}[htp]
    \centering
\includegraphics[scale=.6]{fig/2-41.png}
    \caption{}
\end{figure}
...
前面我们求圆柱、圆锥，
圆台的侧面积公式都是利用它们的展开图求出的，由于球面
不能展成平面图形，所以球的表面积计算公式无法用展开图
求出，我们得另想计算方法。古希腊的几何学家欧都克斯为
我们提供了一个在数学上非常有应用价值的逼近法来解决这
个问题。
