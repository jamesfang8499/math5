...
\begin{figure}[htp]
    ...
    \begin{tikzpicture}[scale=1, node distance = 0pt, LAA/.style = {{Bar[width=5mm].Straight Barb[]}-{Straight Barb[].Bar[width=5mm]},  % <---
    	...
    	\draw (0,0)--(4,0) coordinate(P) --++(3*0.707,3*0.707) coordinate (Q);
    	...
    	\draw[<->] ($(P)+(0.5,0)$) --node[fill=white, midway,rotate=45]{30} ($(Q)+(0.5,0)$);\draw(P)--($(P)+(0.8,0)$); \draw(Q)--($(Q)+(0.8,0)$);
    	\draw (R)--++(0.8*0.707,0.8*0.707) coordinate[pos=0.5](U);
    	\draw (B)--++(0.8*0.707,0.8*0.707) coordinate[pos=0.5](V);
    	\draw[<->] (U) -- node[fill=white, midway]{32} (V);
    \end{tikzpicture}}
    \caption*{第4题}
    \end{minipage}
	...
	\begin{tikzpicture}[scale=1, node distance = 0pt]
		...
		\draw[<->] ($(A)-(0.5*0.866,0.5*0.5)$) -- node[midway,fill=white,rotate=-30]{40} ($(O)-(0.5*0.866,0.5*0.5)$);
		\draw[<->] ($(A)-(0.5*0.866,0.5*0.5)$) -- node[midway,fill=white,rotate=90]{50} ($(A')-(0.5*0.866,0.5*0.5)$);
		\draw[<->] ($(M)-(0.35*0.866,0.35*0.5)$) -- node[midway,fill=white,rotate=-30]{25} ($(O')-(0.35*0.866,0.35*0.5)$);
		...
		\draw[<->] ($(O)+(0.5*0.866,-0.5*0.5)$) -- node[midway,fill=white,rotate=3	0]{30} ($(B)+(0.5*0.866,-0.5*0.5)$);
		...
		\draw (L2) --++ (0,0.8);
		\draw (L') --++ (0,0.8);
		\draw [<->] ($(O')+(0.3*0.866,-0.3*0.5)$) -- node[midway,fill=white,rotate=30,xshift=0.1*0.866cm,yshift=-0.4*0.5cm,inner sep=0pt]{10} ($(B1')+(0.3*0.866,-0.3*0.5)$);
		\draw [<->] ($(B1')+(0.3*0.866,-0.3*0.5)$) -- node[midway,fill=white,rotate=30,xshift=0.1*0.866cm,yshift=-0.4*0.5cm,inner sep=0pt]{10} ($(B2')+(0.3*0.866,-0.3*0.5)$);
		\draw [<->] ($(B2')+(0.3*0.866,-0.3*0.5)$) -- node[midway,fill=white,rotate=30,xshift=0.1*0.866cm,yshift=-0.4*0.5cm,inner sep=0pt]{10} ($(B')+(0.3*0.866,-0.3*0.5)$);
		\draw [<->] ($(L)+(0,0.3)$) -- node[midway,fill=white,yshift=0.4cm,inner sep=0pt]{10} ($(L1)+(0,0.3)$);
		\draw [<->] ($(L1)+(0,0.3)$) -- node[midway,fill=white,yshift=0.4cm,inner sep=0pt]{10} ($(L2)+(0,0.3)$);
		\draw [<->] ($(L2)+(0,0.3)$) -- node[midway,fill=white,yshift=0.4cm,inner sep=0pt]{10} ($(L')+(0,0.3)$);
		\draw[<->] ($(B')+(0.8*0.866,0.8*0.5)$) -- node[midway,fill=white,rotate=90]{15} ($(B)+(0.8*0.866,0.8*0.5)$);
	\end{tikzpicture}
	}
    \caption*{第5题}
    \end{minipage}
